; Program ftocAVG.asm
; takes arguments converts them to farenheit and calculates the average
; Author: Jose Jesus Sinohui
; Date: April 4, 2017

%include '../functions.asm'
section .data
	msj db "The avg of the temperatures in farenheit is: ", 0x0
...
cycle:
	...
	call ctof			; convert it to farenheit
